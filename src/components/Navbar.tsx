    ...
    <header className="sticky top-0 z-50">
      <div className="glass mx-auto mt-4 flex max-w-5xl items-center justify-between rounded-funky px-4 py-3 shadow-card">
        <div className="flex items-center gap-3">
          ...
          <div>
            <p className="text-xs uppercase tracking-[0.2em] text-ink/70">UI Engineer</p>
            <p className="font-semibold text-ink">Imanol Aranzadi</p>
          </div>
        </div>
          ...
          {sections.map(section => (
            <button
              ...
              className={clsx(
                ...
                active === section.id ? 'bg-mint text-ink shadow-card' : 'bg-white/80 text-ink/70'
              )}
            >
